...
class EnhancedJSONContentParser:
    ...
    def _create_structured_prompt(self, content: str, post_type: str, platform: str) -> Dict[str, Any]:
...
5.  **Xuất kết quả:** Trả về một chuỗi văn bản duy nhất tuân thủ tất cả các quy tắc trên."""
    ...
    def _call_gemini_api_structured(self, prompt_data: Dict[str, Any], max_retries: int = 3) -> Optional[str]:
    ...
    def _extract_enhanced_content(self, response: str) -> str:
        """Extract and clean enhanced content from AI response"""
